...
Explanation:
    ...
    Test case 3: 400 > 350, but the students have solved a 400-difficulty level problem before solving a 350-difficulty problem. The students have not solved problems in non-decreasing order, and so the answer is "No".

    Test case 4: 5000 > 3000, but the students have solved a 5000-difficulty level problem before solving a 3000-difficulty problem. The students have not solved problems in non-decreasing order, and so the answer is "No".
